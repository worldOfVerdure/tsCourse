...
const firstRole = roles[0]; //Knows it is "admin" because of as const.
...
//*Satisfies keyword
const dataEntriesR: Record<string, number> = {
  entry1: 0.51,
  entry2: -1.23
};
...
//?More on satisfies: https://www.typescriptlang.org/docs/handbook/release-notes/typescript-4-9.html
